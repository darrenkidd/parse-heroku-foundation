...
// combines them with the Foundation for Apps assets, and outputs the finished files in the "public" folder as a finished app.
...
gulp.task('build', function(cb) {
  sequence('clean', ['copy', 'copy:foundation', 'sass', 'uglify'], 'copy:templates', 'copy:index', cb);
});
...
gulp.task('default', ['server'], function () {
  ...
  // Watch static files
  gulp.watch(['./client/**/*.*', '!./client/templates/**/*.*', '!./client/assets/{scss,js}/**/*.*'], ['build','server']);

  // Watch app templates
  gulp.watch(['./client/templates/**/*.html'], ['build','server']);
});
